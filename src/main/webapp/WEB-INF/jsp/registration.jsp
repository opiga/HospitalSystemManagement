    ...
    <form:form method="POST" modelAttribute="userForm"
        ...
        <div class="form-row">
            <div class="form-group col-md-2">
                <form:label class="text-center"
                            path="dateOfBirth"><spring:message
            ...
            <div class="form-group col-md-4">
                <form:label class="text-center"
                            path="phoneNumber"><spring:message
                        code="label.phoneNumber"/>:</form:label>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <form:label class="text-center"
                            path="password"><spring:message
                        code="label.passwordConfirm"/>:</form:label>
