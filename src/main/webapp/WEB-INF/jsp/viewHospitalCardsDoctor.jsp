...
<div class="p-3 text-center">
    <h1 class="mb-2"><spring:message code="label.hospitalCards"/>, <spring:message
            code="label.doctor"/> ${doctor.firstName} ${doctor.lastName}
    </h1>
</div>
<div class=container>
    <table class="table table-bordered table-hover table-inverse table-striped"
        ...
        <c:forEach var="hospitalCard" items="${hospitalCards}">
            <tr>
                <td>${hospitalCard.patient.firstName} ${hospitalCard.patient.lastName},
                        <spring:message code="label.dateOfBirth"/>:
                        ${hospitalCard.patient.dateOfBirth}
                ...
                <td class="text-center">
                    <a class="btn btn-light"
                       href="${pageContext.request.contextPath}/appointments/addAppointment/${hospitalCard.hospitalCardId}/${hospitalCard.patient.id}/${hospitalCard.doctor.id}/${hospitalCard.nurse.id}">
                        <spring:message code="label.makeAppointment"/>
                    </a>
                    <a class="btn btn-light"
                       href="${pageContext.request.contextPath}/appointments/listAppointments/${hospitalCard.hospitalCardId}">
                        <spring:message code="label.viewAppointment"/>
                    </a>
                </td>
            </tr>
        </c:forEach>
