...
<div class="p-3 text-center">
    <h1 class="mb-2"> <spring:message code="label.edit.card"/>:</h1>
</div>
<style>.error {
    color: red;
}</style>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <form:select class="form-control" path="doctor.id">
                    <form:option value="" label="Choose a doctor"
                                 disabled="${editedHospitalCard.doctor == null}"/>
            ...
            <div class="form-group col-md-4">
                ...
                <form:select class="form-control" path="nurse.id">
                    <form:option value="" label="Choose a nurse"
                                 disabled="${editedHospitalCard.nurse == null}"/>
