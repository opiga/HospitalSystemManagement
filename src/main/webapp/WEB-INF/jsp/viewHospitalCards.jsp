...
<div class=container>
    ...
    <table class="table table-bordered table-hover table-inverse table-striped"
        ...
        <tr>
            ...
            <th class="text-center"><spring:message code="label.doctor"/>
            <th class="text-center"><spring:message code="label.category"/>
            <th class="text-center"><spring:message code="label.nurse"/>
        ...
        <tr>
            ...
            <td class="text-center">
                <a class="btn btn-light"
                   href="${pageContext.request.contextPath}/hospitalcards/edit/${hospitalCard.hospitalCardId}"><spring:message code="label.edit"/></a>
                </c:forEach>
    </table>

    <br>
    <a class="btn btn-secondary"
       href="${pageContext.request.contextPath}/hospitalcards/addhospitalcard/${hospitalCardPatient.id}"><spring:message code="label.addHospitalCard"/></a>
</div>
<br>
<br>
<br>
