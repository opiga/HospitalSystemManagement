...
<div class="container">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                <form:label class="text-center" path="firstName"><spring:message code="label.firstName"/>:</form:label>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <form:label class="text-center" path="dateOfBirth"><spring:message code="label.dateOfBirth"/>:</form:label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <form:label class="text-center" path="phoneNumber"><spring:message code="label.phoneNumber"/>:</form:label>
        ...
        <button type="submit" class="btn btn-secondary" value="Save"><spring:message code="label.save"/>
        </button>
    </form:form>
